...
urlpatterns = [
    ...
    path('question/<str:id>', question_edit, name="question_edit"),
    path('question/<str:id>', question_update, name="question_update"),
    path('question/<str:id>', question_delete, name="question_delete"),
