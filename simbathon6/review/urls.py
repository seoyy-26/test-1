...
app_name = "review"
urlpatterns = [
    path('', showreview, name="showreview"),
    path('<str:id>',review_detail, name= "review_detail"),
    path('review_new/', review_new, name="review_new"),
    path('review_create/',review_create,name="review_create"),
    path('edit/<str:id>',review_edit, name="review_edit"),
    path('update/<str:id>',review_update, name="review_update"),
    path('delete/<str:id>', review_delete, name="review_delete"),
